  ...
  return (
    ...
    < div className="relative w-full flex flex-col" >
      ...
      <div className="absolute inset-0 flex items-center">
        <img alt="art" src={!artistData.artistArtwork?.artistAvatar ? artistData?.artistArtwork?.coverArt : artistData?.artistArtwork?.artistAvatar} width="64px" className="cursor-pointer rounded-full ml-2 shadow-lg shadow-indigo-500/50" />
